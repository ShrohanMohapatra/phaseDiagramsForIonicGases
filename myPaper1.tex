...
\begin{equation}
Z(N, P, T) = \int_{V=0}^{V=\infty} dV \frac{P dV}{k_B T} e^{-\frac{P V}{k_B T}} Z_{c}(N, V, T)
\end{equation}
...
\end{flalign*}
As such, there is no explicit dependence of the canonical partition function on the volume; the implicit relationship between $V$ and $N$ is dictated by the symmetric geometry, $V = N a^3$.
